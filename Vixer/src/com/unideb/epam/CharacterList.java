...
public class CharacterList extends Rectangle{
    ...
    CharacterList(int x, int y, int width, int height, String s){
    ...
    public void basic_add(){
        voice.add(new Voice("Robot",0,0,0));
        voice.add(new Voice("Demon",100,10,90));
        voice.add(new Voice("Dracula",40,30,80));
        voice.add(new Voice("God",30,40,70));
        voice.add(new Voice("Super",20,50,60));
        voice.add(new Voice("Chipmunk",10,60,60));
    }
