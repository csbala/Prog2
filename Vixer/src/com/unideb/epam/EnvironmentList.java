...
public class EnvironmentList extends Rectangle{
    ...
    EnvironmentList(int x, int y, int width, int height, String s){
    ...
    public void basic_add(){
        voice.add(new Voice("Cave",0,100,0));
        voice.add(new Voice("Bathroom",100,10,90));
        voice.add(new Voice("Hangar",40,30,80));
        voice.add(new Voice("Concert Hall",30,100,70));
        voice.add(new Voice("Mountain",20,50,60));
        voice.add(new Voice("Stadium",10,60,60));
    }
