...
public class EffectList extends Rectangle{
    ...
    EffectList(int x, int y, int width, int height, String s){
    ...
    public void basic_add(){
        voice.add(new Voice("AM Radio",0,100,0));
        voice.add(new Voice("Announcer",100,10,90));
        voice.add(new Voice("Radio",40,30,80));
        voice.add(new Voice("Female",30,100,70));
        voice.add(new Voice("Deep voice",20,50,60));
        voice.add(new Voice("Stadium Announcer",10,60,60));
    }
